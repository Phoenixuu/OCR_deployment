    ...
    def __init__(self, model_file=None, session=None):
        ...
        if self.session is None:
            ...
            trt_ep_options = {
                ...
                "trt_profile_min_shapes": "input.1:1x3x256x256",
                "trt_profile_max_shapes": "input.1:16x3x960x960",
                "trt_profile_opt_shapes": "input.1:8x3x512x512"
            }
            ...
            self.session = onnxruntime.InferenceSession(self.model_file, providers=[("CUDAExecutionProvider", {"cudnn_conv_use_max_workspace": '1'}),("CPUExecutionProvider"),], sess_options=session_options)
            #self.session = onnxruntime.InferenceSession(self.model_file, providers=[("TensorrtExecutionProvider", trt_ep_options), "CUDAExecutionProvider",], sess_options=session_options)
...
if __name__ == '__main__':
    ...
    detector.prepare(-1)
    img_paths = ['../data/images/face/0.jpg']
